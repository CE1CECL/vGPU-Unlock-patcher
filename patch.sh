...
GNRL="NVIDIA-Linux-x86_64-525.125.06"
VGPU="NVIDIA-Linux-x86_64-525.125.03-vgpu-kvm"
GRID="NVIDIA-Linux-x86_64-525.125.06-grid"
...
WSYS="NVIDIA-Windows-x86_64-529.11"
...
if $DO_VGPU; then
    ...
    vcfgclone ${TARGET}/vgpuConfig.xml 0x1E30 0x12BA 0x21c4 0x0000	# GTX 1660 6GB
